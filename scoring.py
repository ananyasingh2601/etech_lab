    ...
    for question in exam_questions:
        ...
        if results and 'documents' in results and results['documents']:
            ...
            for idx, (doc, meta) in enumerate(zip(docs, metas)):
                ...
                similarity = 1 - distances[idx] if idx < len(distances) else 0.5
...
def generate_score_dataframe(topic_scores):
    ...
    if not topic_scores: 
        return pd.DataFrame(columns=["Topic Snippet", "Relevance Score", "Similarity", "File", "Page", 
                                     "Lecture Topic", "Year"])
    ...
    return df[["Topic Snippet", "Relevance Score", "Similarity", "File", "Page", 
               "Lecture Topic", "Year"]]